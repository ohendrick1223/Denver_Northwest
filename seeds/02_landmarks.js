      ...
      knex('landmarks').insert(
        {
          ...
          photo_url_2: '/assets/skinner2.jpg',
      ...
      knex('landmarks').insert(
        {
          ...
          photo_url_2: '/assets/billysinn2.jpg',
      ...
      knex('landmarks').insert(
        {
          ...
          photo_url_2: '/assets/panaderiarosales2.jpg',
      ...
      knex('landmarks').insert(
        {
          ...
          photo_url_2: '/assets/betheden2.jpeg',
      ...
      knex('landmarks').insert(
        {
          ...
          photo_url_2: '/assets/guadalupeinside.jpg',
      ...
      knex('landmarks').insert(
        {
          ...
          photo_url_2: '/assets/sassafrass2.jpg',
      ...
      knex('landmarks').insert(
        {
          ...
          photo_url_2: '/assets/briarcommonold.jpg',
      ...
      knex('landmarks').insert(
        {
          ...
          photo_url_recent: '/assets/andersonhousenew.png',
          photo_url_2: '/assets/andersonhousedevelopment.jpg',
      ...
      knex('landmarks').insert(
        {
          ...
          photo_url_2: '/assets/adamsmysteryplayhouse.jpg',
