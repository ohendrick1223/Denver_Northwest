      ...
      knex('landmarks').insert(
        {
          ...
          description: 'A historic disctrict bound by_______Potter-Highlands represents a broad range of architectural styles, indicative of the district’s two distinct periods of development:the first beginning in 1874 up to the Silver Crash in 1893 and the second from the 1896 annexation of the area to Denver until the mid 1940s. The architectural styles include Queen Anne, Craftsman Bungalow, Classic Cottage, and a small percentage of Denver Squares, Colonial and Dutch Revivals, Mission, and Prairie styles. Potter Highlands features a unique layout, most commonlyfound only in the Highland Neighborhood of Denver, which is large square blocks with historic interior carriage lots. The majority of the structures are brick masonry. A few of the oldest structures are wood frame.',
          photo_url: '',
          address:'',
          longitude: -104.990251,
          latitude: 39.7392358,
      ...
      knex('landmarks').insert(
        {
          ...
          description: 'Opened in October, 2016, Briar Common Brewery is one of the recent additions to the historic Jefferson Park neighborhood. The building served as a local grocery store for some time, before being converted to a two-story local brewery and restaurant.',
          photo_url: '',
